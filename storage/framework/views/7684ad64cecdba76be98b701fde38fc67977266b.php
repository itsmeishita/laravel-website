...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> || Best Website Development Company in Bhadohi</title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png" />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
    <meta name="description" content="<?php echo $__env->yieldContent('description', ' Chikuweb- Fresh Solutions, Always | Best Website Development Company in Bhadohi | ChikuWeb - Your Reliable Web Solutions Provider'); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/nisoz-icons/style.css')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/owl-carousel/assets/owl.carousel.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/owl-carousel/assets/owl.theme.default.min.css')); ?>" />
...
<body class="custom-cursor">
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="<?php echo e(asset('assets/images/logo-light.png')); ?>" width="96" height="34" alt="nisoz" /></a>
            </div>
            <!-- /.logo-box -->
    ...
    <script src="<?php echo e(asset('assets/vendors/jquery/jquery-3.5.1.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/vendors/tilt/tilt.jquery.js')); ?>"></script>
    ...
    <!-- template js -->
    <script src="<?php echo e(asset('assets/js/nisoz.js')); ?>"></script>
    <?php echo $__env->yieldContent('script'); ?>
</body>
</html><?php /**PATH C:\Users\dell\Desktop\html_Tamplate\laravel-projects\chiku-redesign\resources\views/default.blade.php ENDPATH**/ ?>