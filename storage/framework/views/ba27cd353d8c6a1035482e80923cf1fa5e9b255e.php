...
<?php $__env->startSection('title','website designing'); ?>
...
<section class="page-header">
    ...
    <div class="container">
        ...
        <h2 class="page-header__title">Website Designing</h2><!-- /.page-title -->
    </div><!-- /.container -->
</section><!-- /.page-header -->
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 wow fadeInUp animated" data-wow-delay="400ms">
                <div class="services-details__content">
                    <div class="services-details__thumb"><img src="assets/images/service/website-designing.jpg" alt="nisoz"></div>
...
<?php echo $__env->make('default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\html_Tamplate\laravel-projects\chiku-redesign\resources\views/website-designing.blade.php ENDPATH**/ ?>