...
<div class="stricky-header stricked-menu main-menu">
		...
		"margin": 0
                ...
                <div class="item"><!-- slider item start -->
                    <div class="main-slider__item">
                        <div class="main-slider__shape-1">
                            <img src="<?php echo e(asset('assets/images/shapes/slider-1-bg-1.png')); ?>" alt="nisoz">
                        </div><!-- shape-one -->
                        <div class="main-slider__shape-2">
                            <img src="<?php echo e(asset('assets/images/shapes/slider-1-shape-1.png')); ?>" alt="nisoz">
                        </div><!-- shape-two -->
                        <div class="main-slider__shape-3">
                            <img src="<?php echo e(asset('assets/images/backgrounds/slier-1-bg-1.jpg')); ?>" alt="nisoz">
                        </div><!-- shape-three -->
                        <div class="main-slider__shape-4">
                            <img src="<?php echo e(asset('assets/images/shapes/slider-1-shape-2.png')); ?>" alt="nisoz">
                        </div><!-- shape-four -->
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-8">
                ...
                <div class="item"><!-- slider item start -->
                    <div class="main-slider__item">
                        ...
                        <div class="main-slider__shape-3">
                            <img src="<?php echo e(asset('assets/images/backgrounds/slier-1-bg-2.jpg')); ?>" alt="nisoz">
                        </div><!-- shape-three -->
                        <div class="main-slider__shape-4">
                            <img src="<?php echo e(asset('assets/images/shapes/slider-1-shape-2.png')); ?>" alt="nisoz">
                        </div><!-- shape-four -->
                ...
                <div class="item"><!-- slider item start -->
                    <div class="main-slider__item">
                        ...
                        <div class="main-slider__shape-3">
                            <img src="<?php echo e(asset('assets/images/backgrounds/slier-1-bg-3.jpg')); ?>" alt="nisoz">
                        </div><!-- shape-three -->
                        <div class="main-slider__shape-4">
                            <img src="<?php echo e(asset('assets/images/shapes/slider-1-shape-2.png')); ?>" alt="nisoz">
                        </div><!-- shape-four -->
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__thumb"><!-- about thumb start -->
                            <div class="about-one__thumb__one wow fadeInLeft" data-wow-delay="100ms">
                                <img src="<?php echo e(asset('assets/images/resources/about-1-1.jpg')); ?>" alt="nisoz">
                            </div>
                            <div class="about-one__thumb__two nisoz-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 10, "speed": 700, "scale": 1 }'>
                                <img src="<?php echo e(asset('assets/images/resources/about-1-2.jpg')); ?>" alt="nisoz">
                            </div>
            ...
            "responsive":{
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img src="<?php echo e(asset('assets/images/brand/brand-1-1.png')); ?>" alt="nisoz">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img src="<?php echo e(asset('assets/images/brand/brand-1-1.png')); ?>" alt="nisoz">
                    </div><!-- /.owl-slide-item-->
        ...
        <section class="cta-one jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
            <div class="cta-one__bg jarallax-img" style='background-image: url("<?php echo e(asset('assets/images/backgrounds/cta-bg-1.jpg')); ?>")' ></div>
            <div class="container">
                <div class="row">
            ...
            "responsive":{
                ...
                "1300":{
                    ...
                    <div class="item"><!-- slider-item-start -->
                        <div class="portfolio-one__item">
                            <div class="portfolio-one__thumb">
                                <img src="<?php echo e(asset('assets/images/portfolio/portfolio-1-1.jpg')); ?>" alt="nisoz" />
                            </div>
                    ...
                    <div class="item"><!-- slider-item-start -->
                        <div class="portfolio-one__item">
                            <div class="portfolio-one__thumb">
                                <img src="<?php echo e(asset('assets/images/portfolio/portfolio-1-2.jpg')); ?>" alt="nisoz" />
                            </div>
                            <div class="portfolio-one__hover">
                                <a class="portfolio-one__read-more" href="portfolio-details.html"><span class="icon-right-arrow"></span></a>
                                <div class="portfolio-one__hover-bottom">
                    ...
                    <div class="item"><!-- slider-item-start -->
                        <div class="portfolio-one__item">
                            <div class="portfolio-one__thumb">
                                <img src="<?php echo e(asset('assets/images/portfolio/portfolio-1-3.jpg')); ?>" alt="nisoz" />
                            </div>
                            <div class="portfolio-one__hover">
                                <a class="portfolio-one__read-more" href="portfolio-details.html"><span class="icon-right-arrow"></span></a>
                                <div class="portfolio-one__hover-bottom">
        ...
        <section class="testimonial-one">
            ...
            "navText": ["<span class=\"icon-left-arrow\"></span>","<span class=\"icon-right-arrow\"></span>"]
                    ...
                    <div class="item">
                        <div class="testimonial-one__item">
                            <div class="testimonial-one__author">
                                <img src="<?php echo e(asset('assets/images/resources/testimonial-1-1.jpg')); ?>" alt="nisoz">
                    ...
                    <div class="item">
                        <div class="testimonial-one__item">
                            <div class="testimonial-one__author">
                                <img src="<?php echo e(asset('assets/images/resources/testimonial-1-2.jpg')); ?>" alt="nisoz">
                                <div class="testimonial-one__icon"><span class="icon-quote"></span></div><!-- testimonial-quote-icon -->
                                <div class="testimonial-one__border">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="290" viewBox="0 0 21 290">
                                        <path class="cls-1" d="M761,4387h1v76.34l-20,24.11,20,26.24V4677h-1V4513.68l-20-26.16,20-24.1V4387Z" transform="translate(-741 -4387)" />
                    ...
                    <div class="item">
                        <div class="testimonial-one__item">
                            <div class="testimonial-one__author">
                                <img src="<?php echo e(asset('assets/images/resources/testimonial-1-3.jpg')); ?>" alt="nisoz">
                                <div class="testimonial-one__icon"><span class="icon-quote"></span></div><!-- testimonial-quote-icon -->
                                <div class="testimonial-one__border">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="290" viewBox="0 0 21 290">
                                        <path class="cls-1" d="M761,4387h1v76.34l-20,24.11,20,26.24V4677h-1V4513.68l-20-26.16,20-24.1V4387Z" transform="translate(-741 -4387)" />
                    ...
                    <div class="col-lg-7">
                        <div class="nisoz-stretch-element-inside-column">
                            <div class="nisoz-stretch__image wow slideInRight" data-wow-delay="400ms">
                                <img src="<?php echo e(asset('assets/images/resources/choose-1.jpg')); ?>" alt="ogency">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="blog-one__item">
                            <div class="blog-one__image">
                                <img src="<?php echo e(asset('assets/images/blog/blog-1-1.jpg')); ?>" alt="Five ways that can develop your business">
                            ...
                            <div class="blog-one__content">
                                <div class="blog-one__meta">
                                    <div class="blog-one__meta__author">
                                        <div class="blog-one__meta__thumb"><img src="<?php echo e(asset('assets/images/blog/author-1.png')); ?>" alt="nisoz" /></div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="blog-one__item">
                            <div class="blog-one__image">
                                <img src="<?php echo e(asset('assets/images/blog/blog-1-2.jpg')); ?>" alt="Get a few solutions to hire a best candidate">
                                <a href="blog-details-right.html"></a>
                                <div class="blog-one__date">
                                    <span>30</span>
                                    June, 2023
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="blog-one__item">
                            <div class="blog-one__image">
                                <img src="<?php echo e(asset('assets/images/blog/blog-1-3.jpg')); ?>" alt="Introducing the latest tech features for you">
                                <a href="blog-details-right.html"></a>
                                <div class="blog-one__date">
                                    <span>30</span>
                                    June, 2023
...
<?php echo $__env->make('default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\html_Tamplate\laravel-projects\chiku-redesign\resources\views/index.blade.php ENDPATH**/ ?>