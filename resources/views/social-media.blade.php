...
<section class="page-header">
    ...
    <div class="container">
        ...
        <h2 class="page-header__title">Social Marketing</h2><!-- /.page-title -->
    </div><!-- /.container -->
</section><!-- /.page-header -->
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 wow fadeInUp animated" data-wow-delay="400ms">
                <div class="services-details__content">
                    <div class="services-details__thumb"><img src="assets/images/service/social-marketing.jpg" alt="nisoz"></div>
                    <h3 class="services-details__content__title">Social Marketing</h3>
