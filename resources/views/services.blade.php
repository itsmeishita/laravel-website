                    ...
                    <div class="service-two__item">
                        ...
                        <div class="service-two__content">
                            ...
                            <h3 class="service-two__item__title">
                                <a href="website-designing.html">Web Development</a>
                            </h3><!-- /.service-title -->
                            <div class="service-two__item__border"></div>
                            <p class="service-two__item__text"> Building robust, responsive websites designed to enhance user experience and drive engagement.</p><!-- /.service-content -->
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="service-two__item">
                        ...
                        <div class="service-two__content">
                            ...
                            <div class="service-two__item__border"></div>
                            <p class="service-two__item__text">Creating intuitive, user-centered designs that blend aesthetics with functionality for seamless digital interactions.</p><!-- /.service-content -->
                        </div>
                    </div><!-- /.service-card-one -->
                </div>
                    ...
                    <div class="service-two__item">
                        ...
                        <div class="service-two__content">
                            ...
                            <p class="service-two__item__text">
                                Developing versatile, high-performing applications tailored to meet specific business needs across platforms.</p><!-- /.service-content -->
                        </div>
                    </div><!-- /.service-card-one -->
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="service-two__item">
                        ...
                        <div class="service-two__content">
                            ...
                            <div class="service-two__item__border"></div>
                            <p class="service-two__item__text">
                                Implementing effective digital marketing strategies to increase brand visibility and drive customer engagement.</p><!-- /.service-content -->
                        </div>
                    </div><!-- /.service-card-one -->
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="service-two__item">
                        ...
                        <div class="service-two__content">
                            ...
                            <div class="service-two__item__border"></div>
                            <p class="service-two__item__text">
                                Producing high-quality, engaging content tailored to communicate your brand's story and values effectively.</p><!-- /.service-content -->
                        </div>
                    </div><!-- /.service-card-one -->
                </div>
            </div>
