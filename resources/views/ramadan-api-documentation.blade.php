...
<section>
    <div class="container">
        <h3 class="page-header__title" style="color: #333; text-align: center;">Ramadan API Documentation</h3>
    </div>
    <!-- Accordian Start -->
                    ...
                    <div class="accrodion-one__wrapper nisoz-accrodion" data-grp-name="nisoz-accrodion">
                        <div class="accrodion">
                            ...
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>API URL https://chikuweb.in/api/ramadan/all
                                        ...
                                        Explanation: This endpoint returns the Sehri and Iftar times for all days of Ramadan for the specified year.</p>
                        ...
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>What is the most important thing in a designing?</h4>
                            </div><!-- /.accordian-title -->
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>There are many variations of passages of available but the have suffered
                        ...
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>What is the purpose of a UI / UX?</h4>
                            </div><!-- /.accordian-title -->
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>There are many variations of passages of available but the have suffered
