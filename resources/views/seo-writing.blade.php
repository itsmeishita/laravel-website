@extends('default')
@section('title','seo&contentwriting')
...
<section class="page-header">
    ...
    <div class="container">
        ...
        <h2 class="page-header__title">SEO & Content Writing</h2><!-- /.page-title -->
    </div><!-- /.container -->
</section><!-- /.page-header -->
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 wow fadeInUp animated" data-wow-delay="400ms">
                <div class="services-details__content">
                    <div class="services-details__thumb"><img src="assets/images/service/seo-content.jpg" alt="nisoz"></div>
                    <h3 class="services-details__content__title">SEO & Content Writing</h3>
