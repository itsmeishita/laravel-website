...
<!-- Mirrored from bracketweb.com/nisoz-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Jul 2025 14:41:23 GMT -->
            ...
            <nav class="main-menu">
                <div class="container-fluid">
                    <div class="main-menu__logo">
                        <a href="index.html">
                            <img src="{{ asset('assets/images/logo-light.png') }}" width="96" height="34" alt="Ogency">
                        </a>
                    </div><!-- /.main-menu__logo -->
